# AGENTS.md -- Kuro Rules (local copy)
# Master rules are in: ~/Documents/kuro-rules/rules/
# Local copy (for this repo): rules/

You MUST read the rules relevant to your current task. Read R1 first.
To read a rule, use your 'view_file' tool on rules/rule_*.md.

## ⚠️ Clôture de Session — MANDATORY (Anti-Oubli)

Avant de terminer TOUTE session de travail sur un projet :
1. Le % du projet a-t-il changé ? → Mettre à jour **Epingle_Projets.md** (R80)
2. Le projet est-il dans R90 ? → Confirmer le statut livrable mensuel
3. Écrire ou mettre à jour **SESSION_SUMMARY.md** dans le dossier du projet
4. Kuro détectera automatiquement — mais l'humain CONFIRME avant clôture
...
- **rule_90_livrables_mensuels**: RULE 90: Livrables Mensuels — Mandatory Monthly Deliverable Recall — MANDATORY
