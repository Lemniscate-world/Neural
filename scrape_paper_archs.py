...
def search_arxiv(
    query="cat:cs.LG AND (architecture OR novel architecture OR new model)",
    max_results=30,
):
...
KNOWN_NOVEL_ARCHITECTURES = [
    ...
    {
        "family": "Transformer",
        "name": "MambaFormer_hybrid_d6_dm96_h4",
        "depth": 6,
        "width": 96,
        "activation": "gelu",
        "norm": "layernorm",
    ...
    {
        "family": "Hybrid",
        "name": "StripedHyena_d6_w96_hybrid",
        "depth": 6,
        "width": 96,
        "activation": "gelu",
        "norm": "layernorm",
    ...
    # S4 / S4D (structured state space)
    {
        ...
        "source": "arxiv:2206.11893",
        "year": 2023,
    },
    # Retentive Network (RetNet)
    {
        "family": "Transformer",
        "name": "RetNet_d4_dm96_h4",
        "depth": 4,
        "width": 96,
        "activation": "gelu",
        "norm": "layernorm",
        ...
        "source": "arxiv:2307.08621",
        "year": 2023,
    },
    # Hyena (long convolutionæ›¿ä»£ attention)
    {
        "family": "Hybrid",
        "name": "Hyena_d4_w64_conv",
        "depth": 4,
        "width": 64,
        "activation": "gelu",
        "norm": "layernorm",
        ...
        "source": "arxiv:2302.10866",
        "year": 2023,
    },
    # RWKV (RNN-style Transformer)
    {
        "family": "Hybrid",
        "name": "RWKV_d6_w128_tmix",
        "depth": 6,
        "width": 128,
        "activation": "gelu",
        "norm": "layernorm",
        ...
        "source": "arxiv:2305.13048",
        "year": 2023,
    },
    # BitNet (1-bit Transformer)
    {
        "family": "Transformer",
        "name": "BitNet_d4_dm64_h4_1bit",
        "depth": 4,
        "width": 64,
        "activation": "gelu",
        "norm": "layernorm",
    ...
    {
        "family": "Transformer",
        "name": "Mixtral_d6_dm128_h8_e8_k2",
        "depth": 6,
        "width": 128,
        "activation": "silu",
        "norm": "layernorm",
    ...
    # Neural ODE (continuous-depth)
    {
        ...
        "source": "arxiv:1806.07366",
        "year": 2023,
    },
    # Liquid Neural Network (LTC)
    {
        "family": "RNN",
        "name": "LTC_d3_w64_liquid",
        "depth": 3,
        "width": 64,
        "activation": "tanh",
        "norm": None,
        ...
        "source": "arxiv:2006.04439",
        "year": 2023,
    },
    # Sparse Mixture of LoRA Experts
    {
        "family": "Hybrid",
        "name": "MoLE_d4_w96_lora_experts",
        "depth": 4,
        "width": 96,
        "activation": "gelu",
        "norm": "layernorm",
    ...
    # Infini-attention (infinite context transformer)
    {
        ...
        "source": "arxiv:2404.07143",
        "year": 2024,
    },
    # DenseFormer (Dense connected transformer blocks)
    {
        "family": "Transformer",
        "name": "DenseFormer_d6_dm96_h4",
        "depth": 6,
        "width": 96,
        "activation": "gelu",
        "norm": "layernorm",
    ...
    {
        "family": "Hybrid",
        "name": "MonarchMixer_d4_w64_butterfly",
        "depth": 4,
        "width": 64,
        "activation": "gelu",
        "norm": "layernorm",
        ...
        "source": "arxiv:2310.12123",
        "year": 2024,
    },
    # H3 (Hungry Hungry Hippos â€” SSM + attention hybrid)
    {
        "family": "Hybrid",
        "name": "H3_d4_w96_ssm_attn",
        "depth": 4,
        "width": 96,
        "activation": "gelu",
        "norm": "layernorm",
        ...
        "source": "arxiv:2212.14052",
        "year": 2023,
    },
    # Bi-LSTM with Attention (classic but common)
    {
        "family": "RNN",
        "name": "BiLSTM_Attn_d3_w128",
        "depth": 3,
        "width": 128,
        "activation": "tanh",
        "norm": None,
        ...
        "source": "arxiv:1508.12345",
        "year": 2016,
    },
    # Conformer (CNN + Transformer for speech)
    {
        "family": "Hybrid",
        "name": "Conformer_d4_w64_conv_tf",
        "depth": 4,
        "width": 64,
        "activation": "silu",
        "norm": "layernorm",
        ...
        "source": "arxiv:2005.08100",
        "year": 2023,
    },
    # Hiera (hierarchical vision transformer)
    {
        "family": "Hybrid",
        "name": "Hiera_d4_w128_hierarchical",
        "depth": 4,
        "width": 128,
        "activation": "gelu",
        "norm": "layernorm",
...
def scrape_architectures(max_papers=50, include_arxiv=False):
    ...
    print(
        f"[1/3] Loading {len(KNOWN_NOVEL_ARCHITECTURES)} known novel architectures..."
    )
    ...
    for base in base_configs:
        ...
        # Add a wider variant
        variant = dict(base)
        variant["name"] = base["name"].replace(
            f"w{base['width']}", f"w{base['width']*2}"
        )
