...
def test_training_loop():
    ...
    train_loader = get_data('MNIST', (28, 28, 1), 32, True)
    val_loader = get_data('MNIST', (28, 28, 1), 32, False)
    loss = train_model(model, optimizer, train_loader, val_loader, epochs=1)
...
def test_hpo_objective():
    ...
    trial = MockTrial()
    loss = objective(trial, config, 'MNIST')
