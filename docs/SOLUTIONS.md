...
| 004 | [HuggingFace #44928](https://github.com/huggingface/transformers/issues/44928) Qwen3.5 SDPA explosion | `gradient_health_transition` (bf16 collapse) | `gradient_explosion` (clip_grad_norm=1.0) | Detection script | A creer | Catalogue, FIX-004 lie |
